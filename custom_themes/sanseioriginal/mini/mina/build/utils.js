...
(function() {
  ...
  // promise enhance
  var _equals, _format_num, _is_object, _strip, dataurl2blob, dict, endswith, format_time, guess_file_ext, guess_file_name, isArray, isDefined, isDict, isFunction, isNumber, isObject, isString, isUndefined, isUrl, list, list2dict, list2str, lstrip, now, parse_int, pop, price, rstrip, startswith, str2list, strip, url, uuid4,
    indexOf = [].indexOf;
  ...
  // ---- parse int ----
  parse_int = function(num, _default, _natural) {
    if (_default === void 0) {
      _default = 0;
    }
    if (_natural === void 0) {
    ...
    _default = parseInt(_default) || 0;
    if (typeof _natural !== 'boolean') {
      _natural = parseInt(_natural) || 0;
    }
    try {
      num = parseInt(num);
      if (isNaN(num)) {
