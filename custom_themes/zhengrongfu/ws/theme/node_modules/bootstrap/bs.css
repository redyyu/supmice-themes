...
.form-control:focus {
  ...
  border-color: #ebe1ce;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(199, 168, 115, 0.25);
}
...
.was-validated .form-control:invalid, .form-control.is-invalid {
  ...
  background-position: center right calc(2.25rem / 4);
  background-size: calc(2.25rem / 2) calc(2.25rem / 2);
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='%23ff4136' viewBox='-2 -2 7 7'%3e%3cpath stroke='%23d9534f' d='M0 0l3 3m0-3L0 3'/%3e%3ccircle r='.5'/%3e%3ccircle cx='3' r='.5'/%3e%3ccircle cy='3' r='.5'/%3e%3ccircle cx='3' cy='3' r='.5'/%3e%3c/svg%3E");
}
...
.btn-primary:focus, .btn-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(174, 148, 104, 0.5);
}
...
.btn-secondary:focus, .btn-secondary.focus {
  box-shadow: 0 0 0 0.2rem rgba(171, 145, 101, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(199, 168, 115, 0.5);
}
...
.btn-outline-secondary:focus, .btn-outline-secondary.focus {
  box-shadow: 0 0 0 0.2rem rgba(156, 126, 74, 0.5);
}
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(199, 168, 115, 0.5);
}
...
.custom-select:focus {
  border-color: #ebe1ce;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(235, 225, 206, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(199, 168, 115, 0.25);
}
...
button.bg-primary:focus {
  background-color: #b8914f !important;
}

.bg-secondary {
  background-color: #9c7e4a !important;
}
...
a.text-primary:hover, a.text-primary:focus {
  color: #aa8444 !important;
}

.text-secondary {
  color: #9c7e4a !important;
}

a.text-secondary:hover, a.text-secondary:focus {
  color: #685431 !important;
}
