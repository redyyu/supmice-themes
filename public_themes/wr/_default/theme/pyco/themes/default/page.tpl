<sup-set ng-model="g.ver" value="{{theme_meta.version}}"></sup-set><sup-set ng-model="g.default_img"         value="{{theme_url+'/styles/default_img.jpg'}}"></sup-set><sup-set ng-model="g.opts" object="theme_meta.options"></sup-set><sup-set ng-model="g.bg_presets"         object="[           {key: 'light-bg', label: _('Light')},           {key: 'dark-bg', label: _('Dark')},           {key: 'cover-bg', label: _('Cover')}         ]"></sup-set><sup-set ng-model="g.carousel"         object="[           {             'title': _('Item Title'),             'src': theme_url+'/styles/default_img.jpg',             'caption': _('Click here add content.')           }         ]"></sup-set>
<!-- reset css -->
