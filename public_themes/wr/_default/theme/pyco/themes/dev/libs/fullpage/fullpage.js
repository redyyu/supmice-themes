 ...
 *
 * This lib sucks, I will write by my own. - redy
 */
(function( root, window, document, factory, undefined ) {
    ...
    */
    ...
    // BUGGIE while change hash which is not exists. wrong scrolling index.
    // The problem should because bad idea how to make it scroll.
    // This lib sucks,  too many level functions stuck together, like a gaint matryoshka, make real diffcualt to debug. maybe that's the only way they can keep thier job....
    // I don't want waste time anymore, I will write by my own.
    // - redy
