<sup-set ng-model="g.ver"         value="{{theme_meta.version}}"></sup-set><sup-set ng-model="g.opts"         object="theme_meta.options"></sup-set><sup-set ng-model="g.default_pic"         value="{{theme_url+'/styles/default.jpg'}}"></sup-set>
<!-- theme css -->
  ...
  <div class="container clearfix">
    ...
    <div class="kv">
      <div sup-widget-media
        ...
        <img ng-src="{{meta.featured_img.src || g.default_pic}}"/>
      </div>
    </div>
